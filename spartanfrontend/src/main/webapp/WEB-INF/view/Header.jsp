...
<li class="active"><a href="<c:url value='/ContactUs'></c:url>"><span class="glyphicon glyphicon-earphone"></span>ContactUs</a></li>
  ...
  <li class="active"><a href="<c:url value='/admin/getproductform'></c:url>"><span class="glyphicon glyphicon-plus"></span>Add Product</a></li>
     <li><a href="<c:url value="/all/getcategoryform" ></c:url>"><span class="glyphicon glyphicon-plus"></span>Add Category</a></li>
      <li><a href="<c:url value="/all/getsupplierform" ></c:url>"><span class="glyphicon glyphicon-plus"></span>Add Supplier</a></li>
    </security:authorize>
     <security:authorize access="hasRole('ROLE_USER')">
    <li><a href="/spartanfrontend/cart/getcart"><span class="glyphicon glyphicon-shopping-cart"></span></a></li>
	</security:authorize>
	</ul>
